...
export default class RecipeInput extends Component {
    ...
    handleSubmit(e) {
        ...
        this.setState ({ //this will clear form after submitting.
            title: '',
            instructions: '',
            ingredients: [''],
            img: ''
    ...
    return (
      <div className= 'recipe-form-container'>
        <form className= 'recipe-form' onSubmit={this.handleSubmit}>
            ...
            <label htmlFor="recipe-instructions-input" style={{marginTop: '4px'}}>
                Instructions
            </label>
            <textarea
                key="instructions"
                ...
                value={instructions}
                onChange={this.handleChange}/>
                 {inputs} {/*this renders a list of ingredients from constant above. */}
